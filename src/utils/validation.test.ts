import { createValidationRule, validateField, commonRules, validateStudent, validateTeacher, sanitizeInput } from './validation';
...
describe('Validation Utils', () => {
  ...
  describe('validateStudent', () => {
    it('should validate student data correctly', () => {
      ...
      expect(validateStudent(validData)).toHaveLength(0);
      expect(validateStudent(invalidData)).toHaveLength(3);
    });
  });
  ...
  describe('validateTeacher', () => {
    it('should validate teacher data correctly', () => {
      ...
      expect(validateTeacher(validData)).toHaveLength(0);
      expect(validateTeacher(invalidData)).toHaveLength(3);
    });
  });
