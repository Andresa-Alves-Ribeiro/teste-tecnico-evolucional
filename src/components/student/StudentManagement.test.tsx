...
jest.mock('./management/StudentHeader', () => () => <div data-testid="student-header">Student Header</div>);
jest.mock('./management/StudentStats', () => ({ totalStudents, totalDegrees, totalClasses }: any) => (
...
jest.mock('./StudentFilters', () => ({ onDegreeChange, onClassChange, onGenerateStudents }: any) => (
...
jest.mock('./StudentChart', () => ({ chartData }: any) => (
  <div data-testid="student-chart">{JSON.stringify(chartData)}</div>
));
jest.mock('../common/DataTable', () => ({ items, onEdit, onSave, editingItem, onEditingItemChange, getDegreeColor, getClassColor }: any) => (
