...
const ConfirmationDialog: React.FC<ConfirmationDialogProps> = ({
  ...
  return (
    <div data-testid="dialog-overlay" className="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center z-50 transition-colors">
      <dialog open className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4 shadow-xl transition-colors">
